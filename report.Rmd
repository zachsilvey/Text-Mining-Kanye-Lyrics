...
With the addition of a single `anti_join` we removed the stop words and are left with words containing more information. Somewhat interestingly, love comes to the top, a topic that doesn't seem to be attributed to Kanye's work in popular culture. Let look at the ocurrance of "love" across his albums.
```{r love}
album_words <- lyrics %>%
  unnest_tokens(word, Lyrics) %>%
